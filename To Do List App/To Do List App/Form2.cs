...
namespace To_Do_List_App
{
    public partial class Form2 : Form
    {
        ...
        private void buttonShowHidePassword_Click(object sender, EventArgs e)
        {
            ...
            {
                // Show password
                textBox2.PasswordChar = '\0'; // No masking character, password is visible
                buttonShowHidePassword.Text = "Hide"; // Change button text to "Hide"
            }
            else
            {
                // Hide password
                textBox2.PasswordChar = '●'; // Mask with a dot (●)
                buttonShowHidePassword.Text = "Show"; // Change button text to "Show"
            }
        }
